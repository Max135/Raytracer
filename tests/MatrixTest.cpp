...
void initMatricesMultiplications(Matrix &matrixA, Matrix &matrixB, Matrix &matrixC) {
    double rowA1[] = {1, 2, 3, 4};
    double rowA2[] = {5, 6, 7, 8};
    double rowA3[] = {9, 8, 7, 6};
    double rowA4[] = {5, 4, 3, 2};
    ...
    double rowB1[] = {-2, 1, 2, 3};
    double rowB2[] = {3, 2, 1, -1};
    double rowB3[] = {4, 3, 6, 5};
    double rowB4[] = {1, 2, 7, 8};
    ...
    double rowC1[] = {20, 22, 50, 48};
    double rowC2[] = {44, 54, 114, 108};
    double rowC3[] = {40, 58, 110, 102};
    double rowC4[] = {16, 26, 46, 42};
...
TEST(MatrixTests, TestTupleMultiplication) {
    ...
    double rowA1[] = {1, 2, 3, 4};
    double rowA2[] = {2, 4, 4, 2};
    double rowA3[] = {8, 6, 4, 1};
    double rowA4[] = {0, 0, 0, 1};
...
TEST(MatrixTests, TestIdentityMatrix) {
    ...
    double rowA1[] = {0, 1, 2, 4};
    double rowA2[] = {1, 2, 4, 8};
    double rowA3[] = {2, 4, 8, 16};
    double rowA4[] = {4, 8, 16, 32};
    std::copy(rowA1, rowA1 + 4, matrix[0]);
    std::copy(rowA2, rowA2 + 4, matrix[1]);
    std::copy(rowA3, rowA3 + 4, matrix[2]);
    std::copy(rowA4, rowA4 + 4, matrix[3]);
...
void initMatricesTransposition(Matrix &matrixA, Matrix &matrixB) {
    double rowA1[] = {0, 9, 3, 0};
    double rowA2[] = {9, 8, 0, 8};
    double rowA3[] = {1, 8, 5, 3};
    double rowA4[] = {0, 0, 5, 8};
    std::copy(rowA1, rowA1 + 4, matrixA[0]);
    std::copy(rowA2, rowA2 + 4, matrixA[1]);
    std::copy(rowA3, rowA3 + 4, matrixA[2]);
    std::copy(rowA4, rowA4 + 4, matrixA[3]);

    double rowB1[] = {0, 9, 1, 0};
    double rowB2[] = {9, 8, 8, 0};
    double rowB3[] = {3, 0, 5, 5};
    double rowB4[] = {0, 8, 3, 8};
    std::copy(rowB1, rowB1 + 4, matrixB[0]);
    std::copy(rowB2, rowB2 + 4, matrixB[1]);
    std::copy(rowB3, rowB3 + 4, matrixB[2]);
    std::copy(rowB4, rowB4 + 4, matrixB[3]);
...
void initSubmatrices(Matrix &matrixA, Matrix &resultA, Matrix &matrixB, Matrix &resultB) {
    ...
    double rowB1[] = {-6, 1, 1, 6};
    double rowB2[] = {-8, 5, 8, 6};
    double rowB3[] = {-1, 0, 8, 2};
    double rowB4[] = {-7, 1, -1, 1};
    std::copy(rowB1, rowB1 + 4, matrixB[0]);
    std::copy(rowB2, rowB2 + 4, matrixB[1]);
    std::copy(rowB3, rowB3 + 4, matrixB[2]);
    std::copy(rowB4, rowB4 + 4, matrixB[3]);
...
void initMatricesLargeDeterminant(Matrix &matrixA, Matrix &matrixB) {
    ...
    double rowB1[] = {-2, -8, 3, 5};
    double rowB2[] = {-3, 1, 7, 3};
    double rowB3[] = {1, 2, -9, 6};
    double rowB4[] = {-6, 7, 7, -9};
    std::copy(rowB1, rowB1 + 4, matrixB[0]);
    std::copy(rowB2, rowB2 + 4, matrixB[1]);
    std::copy(rowB3, rowB3 + 4, matrixB[2]);
    std::copy(rowB4, rowB4 + 4, matrixB[3]);
...
void initMatricesInvertibility(Matrix &matrixA, Matrix &matrixB) {
    double rowA1[] = {6, 4, 4, 4};
    double rowA2[] = {5, 5, 7, 6};
    double rowA3[] = {4, -9, 3, -7};
    double rowA4[] = {9, 1, 7, -6};
    std::copy(rowA1, rowA1 + 4, matrixA[0]);
    std::copy(rowA2, rowA2 + 4, matrixA[1]);
    std::copy(rowA3, rowA3 + 4, matrixA[2]);
    std::copy(rowA4, rowA4 + 4, matrixA[3]);

    double rowB1[] = {-4, 2, -2, -3};
    double rowB2[] = {9, 6, 2, 6};
    double rowB3[] = {0, -5, 1, -5};
    double rowB4[] = {0, 0, 0, 0};
    std::copy(rowB1, rowB1 + 4, matrixB[0]);
    std::copy(rowB2, rowB2 + 4, matrixB[1]);
    std::copy(rowB3, rowB3 + 4, matrixB[2]);
    std::copy(rowB4, rowB4 + 4, matrixB[3]);
...
void initMatricesInverse(Matrix &matrixA, Matrix &matrixB) {
    double rowA1[] = {-5, 2, 6, -8};
    double rowA2[] = {1, -5, 1, 8};
    double rowA3[] = {7, 7, -6, -7};
    double rowA4[] = {1, -3, 7, 4};
    std::copy(rowA1, rowA1 + 4, matrixA[0]);
    std::copy(rowA2, rowA2 + 4, matrixA[1]);
    std::copy(rowA3, rowA3 + 4, matrixA[2]);
    std::copy(rowA4, rowA4 + 4, matrixA[3]);

    double rowB1[] = {0.21805, 0.45113, 0.24060, -0.04511};
    double rowB2[] = {-0.80827, -1.45677, -0.44361, 0.52068};
    double rowB3[] = {-0.07895, -0.22368, -0.05263, 0.19737};
    double rowB4[] = {-0.52256, -0.81391, -0.30075, 0.30639};
    std::copy(rowB1, rowB1 + 4, matrixB[0]);
    std::copy(rowB2, rowB2 + 4, matrixB[1]);
    std::copy(rowB3, rowB3 + 4, matrixB[2]);
    std::copy(rowB4, rowB4 + 4, matrixB[3]);
...
void initMatricesInversion(Matrix &matrixA, Matrix &resultA, Matrix &matrixB, Matrix &resultB) {
    double rowA1[] = {8, -5, 9, 2};
    double rowA2[] = {7, 5, 6, 1};
    double rowA3[] = {-6, 0, 9, 6};
    double rowA4[] = {-3, 0, -9, -4};
    std::copy(rowA1, rowA1 + 4, matrixA[0]);
    std::copy(rowA2, rowA2 + 4, matrixA[1]);
    std::copy(rowA3, rowA3 + 4, matrixA[2]);
    std::copy(rowA4, rowA4 + 4, matrixA[3]);

    double rowRA1[] = {-0.15385, -0.15385, -0.28205, -0.53846};
    double rowRA2[] = {-0.07692, 0.12308, 0.02564, 0.03077};
    double rowRA3[] = {0.35897, 0.35897, 0.43590, 0.92308};
    double rowRA4[] = {-0.69231, -0.69231, -0.76923, -1.92308};
    ...
    double rowB1[] = {9, 3, 0, 9};
    double rowB2[] = {-5, -2, -6, -3};
    double rowB3[] = {-4, 9, 6, 4};
    double rowB4[] = {-7, 6, 6, 2};
    std::copy(rowB1, rowB1 + 4, matrixB[0]);
    std::copy(rowB2, rowB2 + 4, matrixB[1]);
    std::copy(rowB3, rowB3 + 4, matrixB[2]);
    std::copy(rowB4, rowB4 + 4, matrixB[3]);

    double rowRB1[] = {-0.04074, -0.07778, 0.14444, -0.22222};
    double rowRB2[] = {-0.07778, 0.03333, 0.36667, -0.33333};
    double rowRB3[] = {-0.02901, -0.14630, -0.10926, 0.12963};
    double rowRB4[] = {0.17778, 0.06667, -0.26667, 0.33333};
...
void initCancelMultiply(Matrix &matrixA, Matrix &matrixB) {
    double rowA1[] = {3, -9, 7, 3};
    double rowA2[] = {3, -8, 2, -9};
    double rowA3[] = {-4, 4, 4, 1};
    double rowA4[] = {-6, 5, -1, 1};
    std::copy(rowA1, rowA1 + 4, matrixA[0]);
    std::copy(rowA2, rowA2 + 4, matrixA[1]);
    std::copy(rowA3, rowA3 + 4, matrixA[2]);
    std::copy(rowA4, rowA4 + 4, matrixA[3]);

    double rowB1[] = {8, 2, 2, 2};
    double rowB2[] = {3, -1, 7, 0};
    double rowB3[] = {7, 0, 5, 4};
    double rowB4[] = {6, -2, 0, 5};
    std::copy(rowB1, rowB1 + 4, matrixB[0]);
    std::copy(rowB2, rowB2 + 4, matrixB[1]);
    std::copy(rowB3, rowB3 + 4, matrixB[2]);
    std::copy(rowB4, rowB4 + 4, matrixB[3]);
